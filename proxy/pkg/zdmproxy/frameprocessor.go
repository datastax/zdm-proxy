...
type FrameProcessor interface {
	AssignUniqueId(rawFrame *frame.RawFrame, internalRequest bool) (*frame.RawFrame, error)
...
func (sip *streamIdProcessor) AssignUniqueId(rawFrame *frame.RawFrame, internalRequest bool) (*frame.RawFrame, error) {
	if rawFrame == nil {
		return rawFrame, nil
	}
	var newId int16
